#############################################################################
# Makefile for building: DDCToolbox
# Generated by qmake (3.1) (Qt 5.15.12)
# Project:  DDCToolbox.pro
# Template: subdirs
# Command: /usr/bin/qmake -o Makefile DDCToolbox.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = DDCToolbox1.0.0
DISTDIR = /home/pany/DDCToolbox/.tmp/DDCToolbox1.0.0
SUBTARGETS    =  \
		sub-src \
		sub-tests
...
sub-src-qmake_all:  FORCE
	...
	cd src/ && $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro
	cd src/ && $(MAKE) -f Makefile qmake_all
sub-src: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile
sub-src-make_first: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile 
sub-src-all: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile all
sub-src-clean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile clean
sub-src-distclean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile install
sub-src-uninstall_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile uninstall
sub-tests-qmake_all:  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro
	cd tests/ && $(MAKE) -f Makefile qmake_all
sub-tests: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile
sub-tests-make_first: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile 
sub-tests-all: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile all
sub-tests-clean: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile clean
sub-tests-distclean: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile distclean
sub-tests-install_subtargets: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile install
sub-tests-uninstall_subtargets: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile uninstall

Makefile: DDCToolbox.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		DDCToolbox.pro
	$(QMAKE) -o Makefile DDCToolbox.pro
...
sub-src-check:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile check
sub-tests-check:
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile check
check: sub-src-check sub-tests-check

sub-src-benchmark:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/src/src.pro ) && $(MAKE) -f Makefile benchmark
sub-tests-benchmark:
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/pany/DDCToolbox/tests/tests.pro ) && $(MAKE) -f Makefile benchmark
benchmark: sub-src-benchmark sub-tests-benchmark
