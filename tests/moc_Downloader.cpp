...
#include <memory>
#include "../src/3rdparty/QSimpleUpdater/src/Downloader.h"
...
QT_MOC_LITERAL(5, 42, 14), // "startedInstall"
...
QT_MOC_LITERAL(25, 300, 22) // "calculateTimeRemaining"
    ...
    "filepath\0startedInstall\0setUrlId\0"
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Downloader::startedInstall)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Downloader::startedInstall(const QString & _t1)
{
