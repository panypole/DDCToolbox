...
#include <memory>
#include "../src/widget/AddPointDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddPointDialog_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject AddPointDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_AddPointDialog.data,
    qt_meta_data_AddPointDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddPointDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddPointDialog.stringdata0))
